...
from useful_functions import new_tab, switch_to
...
class AccountDetail:
    ...
    def _generate_ssn(self):
        ...
        self.set_select(state_control_ID,"kansas")
    ...
    def _generate_phone_number(self):
        ...
        baseURL = 'https://www.fakephonenumber.org/UnitedStates/phone_number_generator?state=KS'
